...
MIDDLEWARE = [
    ...
    #'django.middleware.locale.LocaleMiddleware', #uses the browser default language
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.i18n', #added to fix the language to portuguese
